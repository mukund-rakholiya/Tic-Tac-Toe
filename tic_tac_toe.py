...
board = [[0, 0, 0],
        ...
        #These colors are from python logo (Except last one)
color_blue = "#4584b6"
color_yellow = "#ffde57"
...
#window setup
window = tkinter.Tk() #creating the game window
...
#setting up the grid buttons and labels
for row in range(3):
    for column in range(3):
...
button = tkinter.Button(frame, text = "Restart", font = ("Consoas", 20), background = color_gray,
